...
public class TestData {
    ...
    Transaction transaction1 = new Transaction(artefact1, new Date().getTime(),buyer1, seller1, autcionHouse1 ,1.00);
    ...
    Transaction transaction2 = new Transaction(artefact1, new Date().getTime(),buyer2, buyer1, autcionHouse2 ,2.00);
    ...
    Transaction transaction3 = new Transaction(artefact1, new Date().getTime(),buyer3, buyer2, autcionHouse3 ,2.00);
