...
public class TestData {
    ...
    Transaction transaction1 = new Transaction(artefact1, new Date().getTime(),seller1, buyer1, autcionHouse1 ,1.00);
    ...
    Transaction transaction2 = new Transaction(artefact1, new Date().getTime(),buyer1, buyer2, autcionHouse2 ,2.00);
    ...
    StakeHolder buyer3 = new StakeHolder("b3", "John", "123Blvd", 12.00);
    ...
    Transaction transaction3 = new Transaction(artefact1, new Date().getTime(),buyer2, buyer3, autcionHouse3 ,2.00);
