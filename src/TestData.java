...
public class TestData {
    ...
    StakeHolder buyer1 = new StakeHolder("b1", "Jim", "456Blvd", 16.00);
   ...
   public Transaction transaction1 = new Transaction(artefact1, new Date().getTime(),buyer1, seller1, autcionHouse1 ,1.00);
    ...
    StakeHolder buyer2 = new StakeHolder("b2", "Jim", "456Blvd", 16.00);
   ...
   public Transaction transaction2 = new Transaction(artefact1, new Date().getTime(),buyer2, buyer1, autcionHouse2 ,2.00);
    ...
    StakeHolder buyer3 = new StakeHolder("b3", "Jim", "456Blvd", 16.00);
    ...
    public Transaction transaction3 = new Transaction(artefact1, new Date().getTime(),buyer3, buyer2, autcionHouse3 ,2.00);
